...
using TitleSettings = Il2CppNinjaKiwi.GUTS.Models.ContentBrowser.TitleSettings;
...
namespace AllFortified {
    ...
    public sealed class Mod : MelonMod {
        ...
        [HarmonyPatch(typeof(PlayerContentManager), nameof(PlayerContentManager.ValidateTitle))]
        [HarmonyPrefix]
        public static void AllowHiddenInfoChars() {
            TitleSettings titleSettings = PlayerContentManager.BrowserServerSettings.TitleSettings;
